...
# --- Configuration ---
pre_split_dataset_base_path = '../dataset_b/split_dataset_2000'  # Main directory for pre-split data
test_dataset_path = '../dataset_b/dataset_test'
...
class_names = ['sphere', 'cylinder', 'cone', 'cube']
img_size = 640
