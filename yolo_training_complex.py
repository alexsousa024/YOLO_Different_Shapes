...
# --- Configuration ---
pre_split_dataset_base_path = 'split_dataset_2000'  # Main directory for pre-split data
test_dataset_path = 'dataset_test'
output_base_dir = 'yolo_complex_model_2000'  # Main output directory
...
# Model & Training
base_model_path = 'yolov8n.yaml'
num_classes = 4 # As per your provided snippet
class_names = ['sphere', 'cylinder', 'cone', 'cube'] # As per your provided snippet
img_size = 640
...
val_img_source_dir = os.path.join(pre_split_dataset_base_path, 'val', 'images')
val_lbl_source_dir = os.path.join(pre_split_dataset_base_path, 'val', 'labels')
test_img_source_dir = os.path.join(test_dataset_path, 'images')
test_lbl_source_dir = os.path.join(test_dataset_path, 'labels')
...
if not all_sources_exist:
    print("One or more source directories are missing. Please check your dataset structure. Exiting.")
    exit()
