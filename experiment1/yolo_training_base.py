...
# --- Configuration ---
# Path to your pre-split dataset_complexEnv
pre_split_dataset_base_path = '../dataset_a/split_dataset'  # Main directory for pre-split data
...
num_classes = 3
class_names = ['sphere', 'cone', 'cylinder']
img_size = 640

# Predefined Hyperparameters -- found by Random Search (with 6 random combinations)
