...
# ---- Configuration ----
source_images_path = 'dataset_complexEnv/images'
source_labels_path = 'dataset_complexEnv/labels'
output_dir = 'split_dataset_1000'
...
all_images = sorted([os.path.splitext(f)[0] for f in os.listdir(source_images_path) if f.endswith(img_ext)])[:1000]
