...
# --- Configurations ---
SAVE_DIR_IMAGES = "dataset_complexEnv/images"
SAVE_DIR_LABELS = "dataset_complexEnv/labels"
...
while supervisor.step(timestep) != -1 and img_counter < 2000:
    ...
    # Save images (from CAMERA) and annotations (based on DETECTION_CAMERA)
